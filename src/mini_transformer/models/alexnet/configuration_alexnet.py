...
class AlexNetConfig(PreTrainedConfig):
    ...
    def __init__(
        ...
        c1_kernel_size: int = 11,
        c1_padding: int = 0,
        c1_stride: int = 4,
        p1_kernel_size: int = 3,
        p1_padding: int = 1,
        p1_stride: int = 2,
        c2_out_channels: int = 256,
        c2_kernel_size: int = 5,
        c2_padding: int = 2,
        c2_stride: int = 1,
        p2_kernel_size: int = 3,
        p2_padding: int = 0,
        p2_stride: int = 2,
        c3_out_channels: int = 384,
        c3_kernel_size: int = 3,
        c3_padding: int = 1,
        c3_stride: int = 1,
        c4_out_channels: int = 384,
        c4_kernel_size: int = 3,
        c4_padding: int = 1,
        c4_stride: int = 1,
        c5_out_channels: int = 256,
        c5_kernel_size: int = 3,
        c5_padding: int = 1,
        c5_stride: int = 1,
        p5_kernel_size: int = 3,
        p5_padding: int = 0,
        p5_stride: int = 2,
